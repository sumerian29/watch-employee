  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("تم إرسال التقرير", {
        description:
          "تم حفظ التقرير داخل قاعدة البيانات بنجاح.",
      });
          ...
          <CardContent className="p-8">
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <Input
                  placeholder="عنوان المهمة اليومية"
                  value={taskTitle}
                  onChange={(e) =>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  placeholder="اكتب تفاصيل الإنجاز اليومي..."
              ...
              <div className="flex items-center gap-4 rounded-2xl border bg-red-50 p-5">
                ...
                <Label className="text-red-700 font-bold text-lg">
                  هل المهمة عاجلة ؟
                </Label>
              ...
              <Button
                type="submit"
                className="w-full h-14 text-lg rounded-2xl bg-blue-900 hover:bg-blue-800"
              >
